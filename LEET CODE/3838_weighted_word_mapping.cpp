...
# include<vector>
using namespace std;
string generate(vector<string>&words ,vector<int>&weight ){
    string ans= "";
...
int main(){
    ...
    vector<int>weight = {5,3,12,14,1,2,3,2,10,6,6,9,7,8,7,10,8,9,6,9,9,8,3,7,7,2};
    cout<< generate(words,weight);
}